...
def input_company():
    days = int(input("분석하고 싶은 기간을 입력하세요"))

    while not days > 0:
        days = int(input("잘못입력하였습니다. 자연수를 입력하세요" + "종가 추출 기간을 입력하세요"))
    ...
    while not 0 < c_index < 6:
        c_index = int(input("잘못입력하셨습니다. 다시입력하세요, 1:samsung, 2 : lge, 3 : hynix, 4 : naver, 5 : hyun_car"))

    company = ['005930', '066570', '000660', '035420', '005380']
    url = "https://finance.naver.com/item/frgn.nhn?code={}&page=".format(company[c_index-1])
